...
"""
----------------OUT OF DATE--------------------
THIS IS THE 2.0 VERSION OF THE SKELETON FOR THE
FINAL PRODUCT.
"""
...
def geneticAlgorithm(population, popSize, eliteSize, mutationRate, generations, stagnation=False):
    ...
    if stagnation == True:
        ...
        print('Best distance: {}'.format(bestRoute))
        ...
        for i in range(0, generations):
            print('Generation {}| Minimum Distance: {}'.format(i+1, 1 / rankRoutes(pop)[0][1]))
            pop = nextGeneration(pop, eliteSize, mutationRate)
...
numCities = int(input('Enter the integer number of cities you would like your salesman to travel to (default is 25): '))
populationSize = int(input('Enter the integer number of the population size: '))
